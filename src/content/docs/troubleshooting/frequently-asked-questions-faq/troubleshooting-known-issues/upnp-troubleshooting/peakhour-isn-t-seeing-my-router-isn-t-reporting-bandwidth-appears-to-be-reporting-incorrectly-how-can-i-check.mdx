...
description: "If you're using UPnP mode in PeakHour to talk to your router and you know or suspect the reporting is inaccurate, we recommend going through the steps below to…"
sidebar:
  order: 28
status: needs-review
---
...
Here are some tips to interpretting the output:
  ...
  - (Advanced) If the Bytes values appear to be incrementing but you suspect they're not correct, do the following:
      ...
      - (Optional) Use a site like [speedtest.net](http://speedtest.net) to generate a known amount of throughput.
