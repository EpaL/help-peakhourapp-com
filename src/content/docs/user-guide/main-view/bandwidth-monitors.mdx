...
- **Maximum bandwidth lines** — the dashed lines mark the maximum inbound and outbound bandwidth for the device, with optional numeric labels. This shows the configured theoretical maximum bandwidth for the given device or interface. Configure the maximum bandwidth under [Bandwidth Options](/user-guide/settings/monitors-settings/bandwidth-monitor/bandwidth-options/).
