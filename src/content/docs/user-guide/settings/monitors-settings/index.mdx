...
![CleanShot 2023 12 10 at 17.55.05@2x](./images/cleanshot-2023-12-10-at-17-55-05-2x.png)
  ...
  - **Add Latency Monitor**  
    Add a new Latency monitor to measure and monitor latency. For more information on Latency monitors, see here: [Latency Monitor](/user-guide/settings/monitors-settings/latency-monitor/).
