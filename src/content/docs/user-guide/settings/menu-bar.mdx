...
- [Configuring Monitors](#MenuBar-ConfiguringMonitors)
      ...
      - [Latency Menu Bar Item](#MenuBar-ConnectionQualityMenuBarItem)
...
| **Show Totals** | If enabled, the Totals for this monitor will be displayed as well. For more information, see [Totals](/user-guide/settings/monitors-settings/bandwidth-monitor/#totals). |

### Latency Menu Bar Item

A Latency Menu Bar item shows the latency of the host being monitored, in the menu bar. You can customize the default monitor to also include additional information. When finished, click the 'x' or anywhere outside the settings popover to close and update the settings.
...
**Router, ISP and Internet:** Shows all hops from your Mac to the Internet.

**Internet Only:** Only shows the Internet hop. Use this for a more compact view.
