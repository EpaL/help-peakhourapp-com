...
![Usage settings tab showing Enable Usage Monitoring, Billing Cycle, Quota, Notifications and Actions](./usage-images/usage-monitor-settings.png)
...
Notifications alert you when your data usage reaches a threshold you specify. Click **Add Notification…** to create one; you can add as many as you like — for example, an alert at 50%, 75%, and 100% of your quota.

A threshold can be an absolute amount (in MB or GB) or a percentage of your quota. With a Peak / Off-Peak quota, you can set separate thresholds for each.
