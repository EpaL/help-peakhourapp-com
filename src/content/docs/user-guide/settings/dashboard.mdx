...
**Enable Internet Dashboard**

Enables the Internet Dashboard and shows it on the main display.

For more information on the Internet Dashboard and the information it presents, see [Internet Dashboard](/user-guide/main-view/internet-dashboard/).
...
**Periodically measure Internet Speed**
...
You can also manually trigger a speed test on demand by clicking **Run Now** or right-clicking the Internet Dashboard itself and choosing **Run Speed Test**.

## Visual Effects

**Connection line ‘Shimmer’ effect**
