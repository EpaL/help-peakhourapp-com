...
PeakHour Enabler is free and open source. The tool, its downloads, and the full step-by-step setup instructions now live on GitHub:

<p>
  <a href="https://github.com/EpaL/PeakHour-Enabler" target="_blank" rel="noopener noreferrer"><strong>PeakHour Enabler on GitHub →</strong></a>
</p>
