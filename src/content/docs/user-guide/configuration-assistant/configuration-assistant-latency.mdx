...
To monitor throughput instead, choose **Bandwidth** — see [Configuration Assistant: Bandwidth Monitor](/user-guide/configuration-assistant/configuration-assistant-bandwidth/).
