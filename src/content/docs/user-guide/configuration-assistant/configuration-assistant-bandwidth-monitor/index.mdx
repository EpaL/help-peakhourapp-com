...
The symbol and description (or name) for this Monitor. Click either to change them.
...
**Graph View / Summary View**

- **Graph View:** Shows this Monitor with graph (expanded) in the main view.
- **Summary View:** Shows this Monitor without the graph (collapsed) in the main view.
