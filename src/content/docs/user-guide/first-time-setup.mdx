...
- **Enable UPnP on your Internet router.** PeakHour uses UPnP to discover your router automatically during setup. Most routers ship with UPnP on by default — if yours doesn't, look for an option labelled **UPnP** or **Universal Plug & Play** in your router's admin interface and turn it on before launching PeakHour. See [UPnP Troubleshooting](https://peakhoursupport.atlassian.net/wiki/spaces/P5W/pages/9503200/UPnP+Troubleshooting) if your router still isn't discovered.
...
3. **You're All Set** — confirm your configuration before finishing.
4. **Stay in Touch** — optional: subscribe to updates or follow PeakHour on social.
...
The Welcome screen introduces the three main views you'll work with in PeakHour: bandwidth monitoring for your router, ISP and internet endpoints; the Connection Quality Dashboard; and the menu bar widget. Click **Get Started** to continue.
...
- For deeper diagnostics, see [UPnP Troubleshooting](https://peakhoursupport.atlassian.net/wiki/spaces/P5W/pages/9503200/UPnP+Troubleshooting).
